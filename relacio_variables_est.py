...
# Carregar el dataset d'estudiants
df_estudiants = pd.read_csv('estudiants_med.csv')

# Seleccionar només les columnes categòriques de 'df_estudiants'
df_cat = df_estudiants[['sex', 'psyt', 'health', 'year']]

# Inicialitzar una taula buida per guardar els resultats
...
# Analitzem el valor de p-value, si és menor a 0.05 hi ha relació significativa
